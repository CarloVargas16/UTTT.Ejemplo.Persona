<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContraseñaPrincipal.aspx.cs" Inherits="UTTT.Ejemplo.Persona.RegistrarUsuarios.ContraseñaPrincipal" %>
                ...
                <div class="user">
                    <div class="form-wrap">
                    	...
                    	<div class="justify-content-md-center">
                            <h3 class="login-tab log-in active"><a class="log-in active" href="#login-tab-content"><span>Recuperacion de contraceña</span></a></h3>
                    	</div>
                        <!-- TABS CONTENT -->
                        ...
                        <asp:Button class="button" ID="btnAceptar" runat="server" OnClick="btnAceptar_Click" Text="Aceptar" /> 
                     <br />
