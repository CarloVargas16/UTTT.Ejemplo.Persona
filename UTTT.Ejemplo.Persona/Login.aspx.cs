    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dbUser == null)
                {
                    this.lblErrores.Text = "El usuario o la contraseña no son correctos";
                    this.lblErrores.Visible = true;
                    return;
                }
            ...
            catch (Exception ex)
            {
                ...
                msg.To.Add(new MailAddress("tareaspruebascarlo@gmail.com"));
                msg.Subject = "Correo";
                msg.IsBodyHtml = true;
                msg.Body = body;
        ...
        {
            this.Response.Redirect("~/RegistrarUsuarios/ContraseñaPrincipal.aspx", false);
        }
    }
}