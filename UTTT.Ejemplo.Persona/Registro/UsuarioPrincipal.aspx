<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuarioPrincipal.aspx.cs" Inherits="UTTT.Ejemplo.Persona.Registro.UsuarioPrincipal" %>
       ...
       <div style="margin-left: 80px">
        ...
        &nbsp;&nbsp;&nbsp;
                ...
                <SortedDescendingHeaderStyle BackColor="#3E3277" />
                                        ...
                                        <asp:LinqDataSource ID="DataSourceUsuario" runat="server" ContextTypeName="UTTT.Ejemplo.Linq.Data.Entity.DcGeneralDataContext" EntityTypeName="" Select="new (idPersona, strNombreUsuario, idCatValorUsuario, CatValorUsuario, Persona, id)" TableName="Usuario" OnSelecting="DataSourceUsuario_Selecting">
                                        </asp:LinqDataSource>
